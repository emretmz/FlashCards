...
class Ui_widget_Login(object):
    ...
    def retranslateUi(self, Login):
        Login.setWindowTitle(QCoreApplication.translate(
            "Login", u"FLASHCARDS FOR DUTCH LEARNING", None))
        self.label_login.setText(QCoreApplication.translate(
            "Login", u"Learn the 500 most used Dutch words easily!", None))
        self.button_login.setText(
            QCoreApplication.translate("Login", u"LOG IN", None))
        self.button_signup.setText(
            QCoreApplication.translate("Login", u"SIGN UP", None))
        self.label_username.setText(
            QCoreApplication.translate("Login", u"Username", None))
        self.label_usercontrol.setText(
            QCoreApplication.translate("Login", u"", None))
    # retranslateUi
...
class FlashCard(QWidget, Ui_widget_Login):
    def __init__(self):
    ...
    def Register_pressed(self):
        ...
        with open(filename, 'r+', encoding="utf-8") as file:
            ...
            user = list(filter(lambda x: x == username or x ==
                        username.lower() or x == username.upper(), lines))
